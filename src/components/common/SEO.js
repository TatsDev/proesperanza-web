...
const SEO_DATA = {
  description: 'Hermosos y cómodos apartamentos de interés social.',
  title: 'Proyecto Esperanza',
  url: '',
  author: 'Tatiana Davila',
  twitterId: '@creativitad',
  keywords: ['Apartamento', 'Barranquilla', 'Interés', 'Social', 'Vivienda'],
  img: '@images/logos/Logo_Esperanza.jpeg',
};
